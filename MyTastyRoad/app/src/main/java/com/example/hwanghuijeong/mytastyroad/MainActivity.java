        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.navigation_mymap:
                    transaction.replace(R.id.map_fragment, new FragmentMyMap()).commit();
                    mTextMessage.setText("My map");
                    return true;
                case R.id.navigation_memo:
                    transaction.replace(R.id.map_fragment, new FragmentMemo()).commit();
                    mTextMessage.setText("");
                    return true;
                case R.id.navigation_profiles:
                    transaction.replace(R.id.map_fragment, new FragmentProfile()).commit();
